...
def list_record(request):
    try:
        ...
        with connection.cursor() as cursor:
            counter = cursor.execute("SELECT * FROM feedback WHERE record_status=%s "
...
def list_filter(request):
    try:
        ...
        with connection.cursor() as cursor:
            counter = cursor.execute("SELECT * FROM feedback WHERE "
...
def list_search(request):
    try:
        ...
        with connection.cursor() as cursor:
            counter = cursor.execute("SELECT * FROM feedback WHERE record_status=%s AND "
...
def preview(request):
    try:
        ...
        with connection.cursor() as cursor:
            counter = cursor.execute("SELECT * FROM feedback WHERE record_status=%s AND id=%s "
...
def download(request):
    try:
        with connection.cursor() as cursor:
            counter = cursor.execute("SELECT * from feedback "
