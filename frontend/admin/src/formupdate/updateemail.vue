...
<div class="p-1 pb-0 ml-0 pl-0">
    <h5 class="mt-2 text-primary"> Security (Email) </h5>
</div>
</div>
...
<form @submit.prevent="formCheck" class="needs-validation">
            ...
            <div class="col-md-6 mt-1">
                ...
                <div class="input-group">
                    ...
                    <input type="email" v-model="email_one"  minlength="10" maxlength="100" id="email" class="form-control" required placeholder="Email address" readonly>
                </div>
              ...
              <div class="col-md-6">
                <div class="m-1 mt-3">
                    <label for="email_two" class="pb-1 text-dark">Alternative (optional)</label>
                <div class="input-group">
                    <span class="input-group-text"><i class="bi-mailbox"></i></span>
                    <input type="email" v-model="email_two"  minlength="0" maxlength="100" id="email_two" class="form-control" placeholder="Email address">
                </div>
                    <small class="form-text text-muted"></small>
                </div>
            </div>
...
export default {
   ...
   preview: function(){
        ...
        .then(response => {
            ...
            this.email_two = this.info['email_two']
            }else{
            this.record = false
            this.classname=''
    ...
    formCheck: function(e){
        ...
        }else if(!this.validEmail(this.email_two)){
        this.error_btn="Valid email required.";
        }else{
            this.error_btn="";
