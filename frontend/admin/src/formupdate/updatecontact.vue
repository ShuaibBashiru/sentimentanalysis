...
<div class="p-1 pb-0 ml-0 pl-0">
    <h5 class="mt-2 text-primary"> Update contact </h5>
</div>
</div>
...
<form @submit.prevent="formCheck" class="needs-validation">
            ...
            <div class="col-md-6 mt-1">
                ...
                <div class="row">
                <div class="col-md-12">
                    <label for="phone2" class="pb-1 text-dark">Alternative (optional)</label>
                <div class="input-group">
                    <input type="text" v-model="phone_two"  minlength="7" maxlength="15" id="phone2" class="form-control" placeholder="Alternative Number">
                    </div>
                </div>
                    </div>
                    <small class="form-text text-muted"></small>
...
export default {
   ...
   preview: function(){
        ...
        .then(response => {
            ...
            this.phone_two = this.info['phone_two']
            }else{
            this.record = false
            this.classname=''
