...
<div class="p-1 pb-0 ml-0 pl-0">
    <h5 class="mt-2 text-primary"> Date of Birth </h5>
</div>
</div>
...
<form @submit.prevent="formCheck" class="needs-validation">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    <span class="input-group-text"><i class="bi-shield"></i></span>
            ...
            <div class="col-md-6">
                <div class="m-1 mt-3">
                    <label for="sname" class="pb-1 text-dark">Repeat password</label>
                <div class="input-group">
                    <span class="input-group-text"><i class="bi-shield"></i></span>
                    <input type="text" v-model="cpassword" :disabled="isDisabled" minlength="3" maxlength="50" class="form-control" required placeholder="Repeat password">
                </div>
...
export default {
   ...
   preview: function(){
    ...
    formCheck: function(e){
        ...
        this.error_btn="Your password do not match";
        }else{
            this.error_btn="";
            this.$confirm("You are about to change password?, click Ok to continue or Cancel to terminate").then(() => {
    ...
    update: function(){
        ...
        axios.post('/posts/user/updatepassword/', form)
        .then(response => {
        if(response.data.status==response.data.statusmsg){
        this.classname=response.data.classname
        this.alert=response.data.msg
