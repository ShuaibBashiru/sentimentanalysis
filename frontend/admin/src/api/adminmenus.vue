...
<div class="p-1 pb-0 ml-0 pl-0">
    <h5 class="mt-2 text-primary"> Menu (<span class="text-secondary">{{counter}}</span>)</h5>
</div>
</div>
...
<div class="btn-group m-2" title="" role="group" aria-label="First group"><a href="/secure/adminnewmenu" class="btn btn-outline-primary text-center">  <i class="bi-plus" style="font-size: 1rem;"></i> New </a></div>
        ...
        <div class="col-md-12">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-hover table-bordered" id="myTable">
                    ...
                    <td class="text-center" v-else> <i class="bi-x-square btn p-0 text-danger"></i></td>
                    <td class="text-center"> <a :href="'/secure/u_adminmenu/'+d['menuName']+'/'+d['id']"><i class="bi-pencil-square btn p-0 text-primary"></i> </a></td>
                    <td class="text-center"> <a :href="'/secure/d_adminmenu/'+d['menuName']+'/'+d['id']"><i class="bi-trash btn p-0 text-danger"></i> </a></td>
                    </tr>
                      </tbody>
                </table>
            </div>
...
export default {
    ...
    updateStatus: function(){
        ...
        axios.post('/posts/adminmenu/update_status/', form)
        .then(response => {
   ...
   tokenize: function(){
    ...
    preview: function(){
       ...
       filter: function(){
        ...
        this.isDisabled = true
        this.opacity = this.opacity_enable
       axios.get('/api/adminmenu/filter/', {
            params:{
       ...
       searchby: function(){
        ...
        this.isDisabled = true
        this.opacity = this.opacity_enable
       axios.get('/api/adminmenu/search/', {
            params:{
                'search': this.search
            }
        })
        ...
        axios.get('/api/adminmenu/download/', {
            params:{
                "filetype":"excel"
            }
