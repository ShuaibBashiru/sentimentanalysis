...
<div class="p-1 pb-0 ml-0 pl-0">
    <h5 class="mt-2 text-primary"> User  (<span class="text-secondary">{{counter}}</span>)</h5>
</div>
</div>
...
<div class="btn-group m-2" title="" role="group" aria-label="First group"><a href="/secure/useraccount" class="btn btn-outline-primary text-center">  <i class="bi-plus" style="font-size: 1rem;"></i> New </a></div>
<div class="btn-group m-2" title="" role="group" aria-label="First group"><a href="/secure/uploadbulkuser" class="btn btn-primary text-center">  <i class="bi-plus" style="font-size: 1rem;"></i> Upload </a></div>
        ...
        <div class="col-md-12">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-hover table-bordered" id="myTable">
                    ...
                    <td class="text-center"> <a :href="'/secure/personalinfo/'+d['email_one']+'/'+d['id']"><i class="bi-printer btn p-0 text-primary"></i> </a></td>
                    </tr>
                    </tbody>
                </table>
            </div>
...
export default {
    ...
    updateStatus: function(){
        ...
        axios.post('/posts/user/update_status/', form)
        .then(response => {
