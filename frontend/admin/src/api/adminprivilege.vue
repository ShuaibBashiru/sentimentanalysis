...
<div class="p-1 pb-0 ml-0 pl-0">
    <h5 class="mt-2 text-primary"> Menu privilege  (<span class="text-secondary">{{counter}}</span>)</h5>
</div>
</div>
...
<div class="btn-group m-2" title="" role="group" aria-label="First group"><a href="/secure/newprivilege" class="btn btn-outline-primary text-center">  <i class="bi-plus" style="font-size: 1rem;"></i> New </a></div>
...
<div class="container p-0">
    <div class="row">
        <div class="col-md-12">
            ...
            <td class="text-center"> <a :href="'/secure/d_adminprivilege/'+d['menuName']+'/'+d['id']"><i class="bi-trash btn p-0 text-danger"></i> </a></td>
            </tr>
            </tbody>
                </table>
            </div>
...
export default {
    ...
    updateStatus: function(){
        ...
        axios.post('/posts/adminprivilege/update_status/', form)
        .then(response => {
 ...
 tokenize: function(){
    ...
    preview: function(){
        ...
        axios.get('/api/adminprivilege/list/',{
            params:{
       ...
       filter: function(){
        ...
        this.isDisabled = true
        this.opacity = this.opacity_enable
       axios.get('/api/adminprivilege/filter/', {
            params:{
       ...
       searchby: function(){
        ...
        this.isDisabled = true
        this.opacity = this.opacity_enable
       axios.get('/api/adminprivilege/search/', {
            params:{
                'search': this.search
            }
        })
        ...
        axios.get('/api/adminprivilege/download/', {
            params:{
                "filetype":"excel"
            }
