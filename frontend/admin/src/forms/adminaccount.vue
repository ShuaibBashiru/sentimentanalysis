...
<div class="p-1 pb-0 ml-0 pl-0">
    <h5 class="mt-2 text-primary"> Admin account </h5>
</div>
</div>
...
<div class="col-md-12 mx-auto">
  ...
  <form @submit.prevent="formCheck" class="needs-validation">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    <span class="input-group-text"><i class="bi-person"></i></span>
                    <input type="text" v-model="firstname"  minlength="3" maxlength="50" id="fname"  class="form-control" required placeholder="Firstname">
                </div>
                <small class="form-text text-muted"></small>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <small class="form-text text-muted"></small>
                      ...
                      <div class="col-md-6">
                <div class="m-1 mt-3">
                    <label for="personalId" class="pb-1 text-dark">Personal ID</label>
                <div class="input-group">
                    <span class="input-group-text"><i class="bi-file-person"></i></span>
                    <input type="text" v-model="personalId"  maxlength="100" id="personalId" class="form-control" placeholder="ID (Optional)">
                </div>
...
export default {
    ...
    addNew: function(){
        ...
        axios.post('/posts/admin/new/', form)
        .then(response => {
