...
<div class="p-1 pb-0 ml-0 pl-0">
    <h5 class="mt-2 text-primary"> Update job </h5>
</div>
</div>
...
<form @submit.prevent="formCheck" class="needs-validation">
            ...
            <div class="col-md-12 mt-1">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="m-1 mt-3">
                    <label for="job" class="pb-1 text-dark">Job role</label>
                    <div class="input-group">
                    <span class="input-group-text"><i class="bi-person-badge"></i></span>
                        <input type="text" maxlength="200" class="form-control" id="job" v-model="job" placeholder="Job role" required>
                    </div>
                    </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="m-1 mt-3">
                    <label for="department" class="pb-1 text-dark">Department/Unit</label>
                    <div class="input-group">
                    <span class="input-group-text"><i class="bi-building"></i></span>
                        <input type="text" maxlength="200" class="form-control" id="department" v-model="department" placeholder="Department/unit" required>
                    </div>
                    </div>
                    </div>
                    </div>
           ...
           <div class="col-md-4 mt-2 text-center d-flex justify-content-end">
                <div class="m-1">
                    <label for=""></label>
                <div class="input-group">
...
export default {
   ...
   preview: function(){
        ...
        .then(response => {
            ...
            this.job = this.info['job_role']
            this.department = this.info['job_department']
            this.record = true
            }else{
            this.record = false
            this.classname=''
